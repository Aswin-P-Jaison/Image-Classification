...
image_dir = r'C:\Users\aswin\OneDrive\Desktop\deep-learning\New folder\cropped'
...
early_stop = tf.keras.callbacks.EarlyStopping(monitor='accuracy', mode='min', patience=20)
...
print(make_prediction(r'C:\Users\aswin\OneDrive\Desktop\deep-learning\New folder\cropped\virat_kohli\virat_kohli8.png',model))
print('--------------------------------------------------------')